...
function PricingCard({ title, price, duration, isPopular }) {
   return (
      <div className={`relative p-6 rounded-2xl transition-all duration-300 border flex flex-col bg-white hover:shadow-lg hover:-translate-y-1 ${
         isPopular
         ...
         <span className={`text-[10px] font-bold uppercase tracking-widest mb-5 block ${isPopular ? 'text-primary' : 'text-slate-400'}`}>
            {title}
         </span>
