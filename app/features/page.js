...
import ModuleBox from "../../components/Shared/ModuleBox";
  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="pt-16 pb-12">
        {/* Features Hero */}
        <section className="section-container text-center mb-10">
          <div className="mb-4 inline-block rounded-full bg-primary/5 px-4 py-1 text-[10px] font-bold text-primary uppercase tracking-[0.3em] border border-primary/10">
        ...
        <section className="section-container mb-16">
          <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
            ...
            <FeatureCategory
              ...
              features={[
                "Instant Homework Alerts",
                "One-Tap Online Payments",
                "Real-time Feed/Gallery",
                "White-Label Options",
