...
export default function Footer() {
  ...
  return (
    <footer className="relative pt-12 pb-8 bg-transparent overflow-hidden border-t border-gray-100">
      {/* Background Accents */}
      ...
      <div className="section-container relative z-10 px-4">
        <div className="grid lg:grid-cols-12 gap-8 mb-10">
          ...
          <div className="lg:col-span-4">
            <Link href="/" className="inline-block mb-6 group">
              <Image src="/final.png" alt="Tuoora Logo" width={100} height={32} className="transition-opacity group-hover:opacity-80" />
            </Link>
        ...
        <div className="pt-6 border-t border-gray-100 flex flex-col md:flex-row justify-between items-center gap-6">
          ...
          <div className="flex gap-4 order-1 md:order-2 md:mr-16">
            {[
              ...
              { name: 'Instagram', href: 'https://instagram.com/tuoora.institute', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg> },
              { name: 'Facebook', href: 'https://www.facebook.com/people/Tuoora/61590502696946/', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M18 2h-3a5 5 0 0 0-5 5v3H7v4h3v8h4v-8h3l1-4h-4V7a1 1 0 0 1 1-1h3z"/></svg> },
              { name: 'YouTube', href: 'https://www.youtube.com/@tuoora.institute', icon: <svg width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M22.54 6.42a2.78 2.78 0 0 0-1.94-2C18.88 4 12 4 12 4s-6.88 0-8.6.46a2.78 2.78 0 0 0-1.94 2A29 29 0 0 0 1 11.75a29 29 0 0 0 .46 5.33A2.78 2.78 0 0 0 3.4 19c1.72.46 8.6.46 8.6.46s6.88 0 8.6-.46a2.78 2.78 0 0 0 1.94-2 29 29 0 0 0 .46-5.25 29 29 0 0 0-.46-5.33z"/><polygon points="9.75 15.02 15.5 11.75 9.75 8.48 9.75 15.02"/></svg> }
            ].map(social => (
